...
```{r plot-exp1a-BGLM, fig.cap="Exp1a: Results of Bayesian GLM analysis.", fig.width=8, warning=FALSE}
library(patchwork)
...
```{r plot-exp1b-BGLM, fig.cap="Exp1b: Results of Bayesian GLM analysis.", fig.width=8, warning=FALSE}
library(patchwork)
