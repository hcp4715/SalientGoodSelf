...
```{r 'Table_s1_exp_info', ehco = FALSE, results = 'asis'}
...
As in the main text, we used Bayesian hierarchical models (BHMs) to model the data and estimate the *d* prime for signal detection theory approach and the reaction times data. We used BRMs [@Bürkner_2017; @Carpenter_2017_stan] in R to implement Bayesian hierarchical models. 

 <!-- Shall I write more about HDDM here, or just refer the interested reader to the paper? -->

## Results

```{r 'exp1a-dprime-rt', fig.cap="RT and *d* prime of Experiment 1a.", fig.height=4.5, fig.width=9, warning=FALSE}
...
df1a_dprime_anova_apa <- df1a_dprime_anova %>% apa_print()
...
df1a_RT_anova_apa <- df1a_RT_anova %>% apa_print()
...
df1a_RT_anova_m_apa <- df1a_RT_anova_m %>% apa_print()
...
df1a_RT_anova_nm_apa <- df1a_RT_anova_nm %>% apa_print()
...
df1b_dprime_anova_apa <- df1b_dprime_anova %>% apa_print()
...
df1b_RT_anova_apa <- df1b_RT_anova %>% apa_print()
...
df1b_RT_anova_m <- afex::aov_ez('Subject','RT_m', df1b.v.rt_m1,     # using afex's function 
                                  within = c('Valence'))
df1b_RT_anova_m_apa <- df1b_RT_anova_m %>% apa_print()
...
df1b_RT_anova_nm <- afex::aov_ez('Subject','RT_m',df1b.v.rt_m2,     # using afex's function 
                                  within = c('Valence'))
df1b_RT_anova_nm_apa <- df1b_RT_anova_nm %>% apa_print()
...
df1c_dprime_anova_apa <- df1c_dprime_anova %>% apa_print()
...
df1c_RT_anova_apa <- df1c_RT_anova %>% apa_print()
...
df2_dprime_anova_apa <- df2_dprime_anova %>% apa_print()
...
df2_RT_anova_apa <- df2_RT_anova %>% apa_print()
...
df2_RT_anova_m <- afex::aov_ez('Subject','RT_m',df2.v.rt_m1,     # using afex's function 
                                  within = c('Valence'))
df2_RT_anova_m_apa <- df2_RT_anova_m %>% apa_print()
...
df2_RT_anova_nm <- afex::aov_ez('Subject','RT_m',df2.v.rt_m2,     # using afex's function 
                                  within = c('Valence'))
df2_RT_anova_nm_apa <- df2_RT_anova_nm %>% apa_print()
...
df3a_dprime_anova_apa <- df3a_dprime_anova %>% apa_print()
...
df3a_dprime_s_anova_apa <- df3a_dprime_s_anova %>% apa_print()
...
df3a_dprime_o_anova <- df3a.v.dprime_l %>%
  ...
  afex::aov_ez('Subject','dprime', ., within = c('Valence'))
df3a_dprime_o_anova_apa <- df3a_dprime_o_anova %>% apa_print()
...
df3a_RT_anova_apa <- df3a_RT_anova %>% apa_print()
```
...
df3a_RT_anova_m_apa <- df3a_RT_anova_m %>% apa_print()
...
df3a_RT_anova_m_s_apa <- df3a_RT_anova_m_s %>% apa_print()
...
df3a_RT_anova_m_o_apa <- df3a_RT_anova_m_o %>% apa_print()
...
df3a_RT_anova_nm_apa <- df3a_RT_anova_nm %>% apa_print()
```
...
df3b_dprime_anova_apa <- df3b_dprime_anova %>% apa_print()
...
df3b_dprime_anova_s_apa <- df3b_dprime_anova_s %>% apa_print()

df3b_dprime_anova_o <- df3b.v.dprime_l %>%
  dplyr::filter(Identity == "Other") %>%
  afex::aov_ez('Subject','dprime', ., within = c('Valence'))

df3b_dprime_anova_o_apa <- df3b_dprime_anova_o %>% apa_print()
...
df3b_RT_anova_apa <- df3b_RT_anova %>% apa_print()
```
The results of reaction times of matchness trials showed similar pattern as the *d* prime data. We found three-way interaction between matchness, and valence (`r df3b_RT_anova_apa$full$Matchness_Valence`) and then analyzed the matched trials and mismatched trials separately, as in previous experiments.
...
df3b_RT_anova_m <- df3b.v.rt_m %>%
  dplyr::filter(Matchness == "Match") %>%
  afex::aov_ez('Subject','RT_m', ., within = c('Identity','Valence'))
df3b_RT_anova_m_apa <- df3b_RT_anova_m %>% apa_print()
...
df3b.v.rt_m1_s_anova <- df3b.v.rt_m %>%
  dplyr::filter(Matchness == "Match" & Identity == "Self") %>%
  afex::aov_ez('Subject','RT_m', ., within = c('Valence'))
df3b.v.rt_m1_s_anova_apa <- df3b.v.rt_m1_s_anova %>% apa_print()

df3b.v.rt_m1_o_anova <- df3b.v.rt_m %>%
  dplyr::filter(Matchness == "Match" & Identity == "Other") %>%
  afex::aov_ez('Subject','RT_m', ., within = c('Valence'))
df3b.v.rt_m1_o_anova_apa <- df3b.v.rt_m1_o_anova %>% apa_print()

# Mismatch trials
df3b_RT_anova_nm <- df3b.v.rt_m %>%
  dplyr::filter(Matchness == "Mismatch") %>%
  afex::aov_ez('Subject','RT_m', ., within = c('Identity','Valence'))
df3b_RT_anova_nm_apa <- df3b_RT_anova_nm %>% apa_print()

df3b_RT_anova_nm_s <- df3b.v.rt_m %>%
  dplyr::filter(Matchness == "Mismatch" & Identity == "Self") %>%
  afex::aov_ez('Subject','RT_m', ., within = c('Valence'))
df3b_RT_anova_nm_s_apa <- df3b_RT_anova_nm_s %>% apa_print()

df3b_RT_anova_nm_o <- df3b.v.rt_m %>%
  dplyr::filter(Matchness == "Mismatch" & Identity == "Other") %>%
  afex::aov_ez('Subject','RT_m', ., within = c('Valence'))
df3b_RT_anova_nm_o_apa <- df3b_RT_anova_nm_o %>% apa_print()
...
df4a_dprime_anova_apa <- df4a_dprime_anova %>% apa_print()

df4a_dprime_s_anova <- df4a.v.dprime_l %>%
  dplyr::filter(Identity == "Self")%>%
  afex::aov_ez('Subject','dprime', ., within = c('Valence'))
df4a_dprime_s_anova_apa <- df4a_dprime_s_anova %>% apa_print()
...
df4a_dprime_o_anova <- df4a.v.dprime_l %>%
  dplyr::filter(Identity == "Other")%>%
  afex::aov_ez('Subject','dprime', ., within = c('Valence'))
df4a_dprime_o_anova_apa <- df4a_dprime_o_anova %>% apa_print()
...
df4a_RT_anova_apa <- df4a_RT_anova %>% apa_print()

# match trials
df4a_RT_anova_m <- df4a.v.rt_m %>%
  dplyr::filter(Matchness == "Match") %>%
  afex::aov_ez('Subject','RT_m', ., within = c('Identity','Valence'))
df4a_RT_anova_m_apa <- df4a_RT_anova_m %>% apa_print()
...
df4a_RT_anova_m_s <- df4a.v.rt_m %>%
  dplyr::filter(Matchness == "Match" & Identity == "Self") %>%
  afex::aov_ez('Subject','RT_m', ., within = c('Valence'))
df4a_RT_anova_m_s_apa <- df4a_RT_anova_m_s %>% apa_print()
...
df4a_RT_anova_m_o <- df4a.v.rt_m %>%
  dplyr::filter(Matchness == "Match" & Identity == "Other") %>%
  afex::aov_ez('Subject','RT_m', ., within = c('Valence'))
df4a_RT_anova_m_o_apa <- df4a_RT_anova_m_o %>% apa_print()

# Mismatch trials
df4a_RT_anova_nm <- df4a.v.rt_m %>%
  dplyr::filter(Matchness == "Mismatch") %>%
  afex::aov_ez('Subject','RT_m', ., within = c('Identity','Valence'))
df4a_RT_anova_nm_apa <- df4a_RT_anova_nm %>% apa_print()
```
We conducted 2 (Matchness: match v. mismatch) by 2 (Identity: self v. other) by 3 (morality: good, neutral, bad) repeated measure ANOVA. There was a main effect of Matchness (`r df4a_RT_anova_apa$full$Matchness`) and interaction between Matchness and Identity(`r df4a_RT_anova_apa$full$Matchness_Identity`)

We carried out two separate ANOVA for both matched and mismatched trials. The results showed that for matched trials, there was an interaction between valence and identity, `r df4a_RT_anova_m_apa$full$Identity_Valence`. However, there is no main effect of valence (`r df4a_RT_anova_m_apa$full$Valence`). We further broke down the interaction by analyzing the data for self and other pairs separately. There was a significant effect of moral valence for self-stimuli, `r df4a_RT_anova_m_s_apa$full$Valence`, BF10 = 11.16. Paired *t*-tests showed that good-self condition (654 ± 67) were faster relative to bad-self condition (665 ± 64.6), *t*(58) = -3.47, *p* = 0.0028, Cohen’s *d* = -0.451 CI [-0.718 -0.182],  $BF_{10}$ = 27.0, and  over neutral-self condition (664 ± 64), *t*(58) = -2.78, *p* = 0.013, Cohen’s  *d* = -0.362, 95% CI [-0.624 -0.097],  $BF_{10}$ = 4.63. The neutral-self and bad-self conditions did not differ, *t*(58) = -0.44, *p* = 0.89, Cohen’s *d* = 0.0499, CI [-0.305 0.206],  $BF_{10}$ = 0.153. For the stranger condition, the results showed that there was no difference among these conditions, `r df4a_RT_anova_m_o_apa$full$Valence`, $BF_{10}$ = 0.077.
...
df4b_dprime_anova_apa <- df4b_dprime_anova %>% apa_print()
#df4b_dprime_anova <- apa_print(df4b_dprime_anova)
```
We conducted 2 (Identity: self v. other) by 3 (morality: good, neutral, bad) repeated measure ANOVA. The results revealed no effect of valence (`r df4b_dprime_anova_apa$full$Valence`), or identity, `r df4b_dprime_anova_apa$full$Identity`, or their interactions, `r df4b_dprime_anova_apa$full$Identity_Valence`.
...
df4b_RT_anova <- afex::aov_ez('Subject','RT_m',df4b.v.rt_m,     # using afex's function 
                                  within = c('Matchness','Identity','Valence'))
df4b_RT_anova_apa <- df4b_RT_anova %>% apa_print()
```
There was a main effect of Matchness (`r df4b_RT_anova_apa$full$Matchness`), main effect of valence (`r df4b_RT_anova_apa$full$Valence`),  interaction between Matchness and Valence(`r df4b_RT_anova_apa$full$Matchness_Valence`), and three way interaction (`r df4b_RT_anova_apa$full$Matchness_Identity_Valence`).
...
df4b_RT_anova_m_apa <- df4b_RT_anova_m %>% apa_print()
...
df4b_RT_anova_nm <- afex::aov_ez('Subject','RT_m',df4b.v.rt_m2,     # using afex's function 
                                  within = c('Identity','Valence'))
df4b_RT_anova_nm_apa <- df4b_RT_anova_nm %>% apa_print()
...
df4b_RT_anova_m_s <- afex::aov_ez('Subject','RT_m',df4b.v.rt_m1_s,     # using afex's function 
                                  within = c('Valence'))
df4b_RT_anova_m_s_apa <- df4b_RT_anova_m_s %>% apa_print()
...
df4b_RT_anova_m_o <- afex::aov_ez('Subject','RT_m',df4b.v.rt_m1_o,     # using afex's function 
                                  within = c('Valence'))
df4b_RT_anova_m_o_apa <- df4b_RT_anova_m_o %>% apa_print()
...
df5_dprime_anova_apa <- df5_dprime_anova %>% apa_print()
#df4b_dprime_anova <- apa_print(df4b_dprime_anova)
```
...
df5.v.dprime_M_anova <- df5.v.dprime_l %>%
  ...
  afex::aov_ez('Subject','dprime', ., within = c('Valence'))
df5_dprime_M_anova_apa <- df5.v.dprime_M_anova %>% apa_print()
...
df5.v.dprime_E_anova <- df5.v.dprime_l %>%
  ...
  afex::aov_ez('Subject','dprime', ., within = c('Valence'))
df5_dprime_E_anova_apa <- df5.v.dprime_E_anova %>% apa_print()
...
df5.v.dprime_P_anova <- df5.v.dprime_l %>%
  ...
  afex::aov_ez('Subject','dprime', ., within = c('Valence'))
df5_dprime_P_anova_apa <- df5.v.dprime_P_anova %>% apa_print()
...
df5.v.dprime_S_anova <- df5.v.dprime_l %>%
  ...
  afex::aov_ez('Subject','dprime', ., within = c('Valence'))
df5_dprime_S_anova_apa <- df5.v.dprime_S_anova %>% apa_print()
...
For emotion conditions, we found that main effect of valence `r df5_dprime_E_anova_apa$full$Valence`. Post-hoc comparison showed that good (2.13, SE = 0.161) was not different from neutral condition (2.10, SE = 0.125), *t*(37) = 0.163, *p* = 0.9854, but both are higher than  than bad condition (1.79, SE = 0.148) (neutral > bad, *t*(37) = 3.588, *p* = 0.0027; good > bad, *t*(37) = 2.62, *p* = 0.0332).
...
df5_RT_anova_apa <- df5_RT_anova %>% apa_print()

df5.v.rt_anova_m <- df5.v.rt_m %>%
  dplyr::filter(Matchness == "Match") %>%
  afex::aov_ez('Subject','RT_m', ., within = c('taskType','Valence'))
df5.v.rt_anova_m_apa <- df5.v.rt_anova_m %>% apa_print()
...
df6a_dprime_anova <- afex::aov_ez('Subject','dprime',df6a.v.dprime_l,  # using afex's function 
                                  within = c('Valence'))
df6a_dprime_anova_apa <- df6a_dprime_anova %>% apa_print()
...
df6a_RT_anova <- afex::aov_ez('Subject','RT_m',df6a.v.rt_m,     # using afex's function 
                                  within = c('Matchness','Valence'))
df6a_RT_anova_apa <- df6a_RT_anova %>% apa_print()
...
df6a_RT_anova_m <- afex::aov_ez('Subject','RT_m',df6a.v.rt_m1,     # using afex's function 
                                  within = c('Valence'))
df6a_RT_anova_m_apa <- df6a_RT_anova_m %>% apa_print()
...
df6a_RT_anova_nm <- afex::aov_ez('Subject','RT_m', df6a.v.rt_m2,     # using afex's function 
                                  within = c('Valence'))
df6a_RT_anova_nm_apa <- df6a_RT_anova_nm %>% apa_print()
...
df6b_d1_dprime_anova <- afex::aov_ez('Subject','dprime',df6b_d1.v.dprime_l,  # using afex's function 
                                  within = c('Identity','Valence'))
df6b_d1_dprime_anova_apa <- df6b_d1_dprime_anova %>% apa_print()
...
df6b_d1_dprime_s_anova_apa <- df6b_d1_dprime_s_anova %>% apa_print()
...
df6b_d1_dprime_o_anova_apa <- df6b_d1_dprime_o_anova %>% apa_print()
```
### Day one
...
#### *d* prime
There was evidence for the interaction between identity and valence, `r df6b_d1_dprime_anova_apa$full$Identity_Valence`. We further split the self- and other-relevant trials. For the self trials, there was significant effect of valence, `r df6b_d1_dprime_s_anova_apa$full$Valence`. Post-hoc comparison showed that the good-self condition (2.71, SE = 0.199) is better than both neutral-self (1.98, SE = 0.151), *t*(21) = 5.984, *p* < 0.001, and bad-self condition (2.07, SE = 0.154), *t*(21) = 6.555, *p* < 0.001. But there was no significant difference between bad-self and neutral-self, *t*(21) = -1.059, *p* = 0.549. For other trials, there was no significant effect of valence, `r df6b_d1_dprime_o_anova_apa$full$Valence`.
...
df6b_d1_RT_anova <- afex::aov_ez('Subject','RT_m',df6b_d1.v.rt_m,     # using afex's function 
                                  within = c('Matchness','Identity','Valence'))
df6b_d1_RT_anova_apa <- df6b_d1_RT_anova %>% apa_print()
...
df6b_d1_RT_anova_m <- df6b_d1.v %>%
  ...
  dplyr::mutate(Valence = factor(Valence, levels = c("Good","Neutral","Bad")),
                Identity = factor(Identity, levels = c('Self', 'Other'))) %>%
  afex::aov_ez('Subject','RT_m', ., within = c('Identity','Valence'))
df6b_d1_RT_anova_m_apa <- df6b_d1_RT_anova_m %>% apa_print()
...
df6b_d1_RT_anova_m_s_apa <- df6b_d1_RT_anova_m_s %>% apa_print()
...
df6b_d1_RT_anova_m_o <- df6b_d1.v %>%
  ...
  dplyr::mutate(Valence = factor(Valence, levels = c("Good","Neutral","Bad"))) %>%
  afex::aov_ez('Subject','RT_m', ., within = c('Valence'))
df6b_d1_RT_anova_m_o_apa <- df6b_d1_RT_anova_m_o %>% apa_print()
...
df6b_d1_RT_anova_nm <- df6b_d1.v %>%
  ...
  dplyr::ungroup() %>%
  afex::aov_ez('Subject','RT_m', ., within = c('Identity','Valence'))
df6b_d1_RT_anova_nm_apa <- df6b_d1_RT_anova_nm %>% apa_print()
```
...
```{r 6b_dprime_d2, echo=FALSE, results='hide', warning=FALSE, message=FALSE}
df6b_d2_dprime_anova <- afex::aov_ez('Subject','dprime',df6b_d2.v.dprime_l,  # using afex's function 
                                  within = c('Identity','Valence'))
df6b_d2_dprime_anova_apa <- df6b_d2_dprime_anova %>% apa_print()
...
df6b_d2_dprime_s_anova_apa <- df6b_d2_dprime_s_anova %>% apa_print()
...
df6b_d2_RT_anova <- afex::aov_ez('Subject','RT_m',df6b_d2.v.rt_m,     # using afex's function 
                                  within = c('Matchness','Identity','Valence'))
df6b_d2_RT_anova_apa <- df6b_d2_RT_anova %>% apa_print()


df6b_d2_RT_anova_m <- afex::aov_ez('Subject','RT_m',df6b_d2.v.rt_m1,     # using afex's function 
                                  within = c('Identity','Valence'))
df6b_d2_RT_anova_m_apa <- df6b_d2_RT_anova_m %>% apa_print()

posthoc_6b_d2_rt <- emmeans::emmeans(df6b_d2_RT_anova_m, c('Identity',"Valence")) # compare each valence for both self and other condition
...
df6b_d2_RT_anova_m_s_apa <- df6b_d2_RT_anova_m_s %>% apa_print()

posthoc_6b_d2_rt_s <- emmeans::emmeans(df6b_d2_RT_anova_m_s, 'Valence') # compare each valence for both self and other condition
...
df6b_d2_RT_anova_m_o_apa <- df6b_d2_RT_anova_m_o %>% apa_print()
