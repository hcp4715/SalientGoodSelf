...
```{r plot-exp1a-BGLM, fig.cap="Exp1a: Results of Bayesian GLM analysis.", fig.height=8, fig.width=8, warning=FALSE}
library(patchwork)
exp1a_sdt_p/exp1a_rt_p + plot_annotation(tag_levels = 'A')  + plot_layout(nrow = 4, byrow = FALSE)
```
