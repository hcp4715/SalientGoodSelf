...
\caption{\label{tab:Table_s1_exp_info}Information about all experiments.}
...
\begin{figure}
\centering
\includegraphics{Suppl_Materials_individual_Exp_files/figure-latex/exp1a-dprime-rt-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Suppl_Materials_individual_Exp_files/figure-latex/plot-exp1a-BGLM-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Suppl_Materials_individual_Exp_files/figure-latex/plot-exp1a-HDDM-1.pdf}
...
Repeated measures ANOVA revealed main effect of valence, \(F(1.83, 93.20) = 14.98\), \(p < .001\), \(\hat{\eta}^2_G = .053\), 90\% CI \([.000, .129]\). Paired t test showed that the Good-Person condition (1.87 \(\pm\) 0.102) was with greater \emph{d} prime than Neutral condition (1.44 \(\pm\) 0.101, \emph{t}(51) = 5.945, \emph{p} \textless{} 0.001). We also found that the Bad-Person condition (1.67 \(\pm\) 0.11) has also greater \emph{d} prime than neutral condition , \emph{t}(51) = 3.132, \emph{p} = 0.008). There Good-person condition was also slightly greater than the bad condition, \emph{t}(51) = 2.265, \emph{p} = 0.0701.

\hypertarget{reaction-time}{%
\paragraph{Reaction time}\label{reaction-time}}

We found interaction between Matchness and Valence (\(F(1.95, 99.31) = 19.71\), \(p < .001\), \(\hat{\eta}^2_G = .031\), 90\% CI \([.000, .094]\)) and then analyzed the matched trials and mismatched trials separately, as in experiment 1a. For matched trials, we found the effect of valence \(F(1.94, 99.10) = 33.97\), \(p < .001\), \(\hat{\eta}^2_G = .115\), 90\% CI \([.029, .211]\). Post-hoc \emph{t}-tests revealed that shapes associated with Good Person (684 \(\pm\) 8.77) were responded faster than Neutral-Person (740 \(\pm\) 9.84), (\emph{t}(51) = -8.167, \emph{p} \textless{} 0.001) and Bad Person (728 \(\pm\) 9.15), \emph{t}(51) = -5.724, \emph{p} \textless{} 0.0001). While there was no significant differences between Neutral and Bad-Person condition (\emph{t}(51) = 1.686, \emph{p} = 0.221). For non-matched trials, there was no significant effect of Valence (\(F(1.90, 97.13) = 1.80\), \(p = .173\), \(\hat{\eta}^2_G = .003\), 90\% CI \([.000, .022]\)).
...
\begin{figure}
\centering
\includegraphics{Suppl_Materials_individual_Exp_files/figure-latex/plot-exp1b-BGLM-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Suppl_Materials_individual_Exp_files/figure-latex/plot-exp1b-HDDM-1.pdf}
...
Figure \ref{fig:ex1c-dprime-rt} shows \emph{d} prime and reaction times of experiment 1c. We conducted same analysis as in Experiment 1a. Our analysis didn't should effect of valence on \emph{d} prime, \(F(1.93, 42.56) = 0.23\), \(p = .791\), \(\hat{\eta}^2_G = .005\), 90\% CI \([.000, .030]\). Neither the effect of valence on RT (\(F(1.63, 35.81) = 0.22\), \(p = .761\), \(\hat{\eta}^2_G = .001\), 90\% CI \([.000, .000]\)) or interaction between valence and matchness on RT (\(F(1.79, 39.43) = 1.20\), \(p = .308\), \(\hat{\eta}^2_G = .005\), 90\% CI \([.000, .036]\)).
...
\begin{figure}
\centering
\includegraphics{Suppl_Materials_individual_Exp_files/figure-latex/plot-exp1c-BGLM-1.pdf}
...
Experiment 1c was conducted in a old way, i.e., we peeked the data when we collected around 20 participants, and decided to stop because the non-significant results. Although the results were not significant, the pattern was consistent with previous two studies.
...
We found interaction between Matchness and Valence (\(F(1.99, 65.70) = 9.53\), \(p < .001\), \(\hat{\eta}^2_G = .017\), 90\% CI \([.000, .080]\)) and then analyzed the matched trials and mismatched trials separately, as in experiment 1a. For matched trials, we found the effect of valence \(F(1.99, 65.76) = 10.57\), \(p < .001\), \(\hat{\eta}^2_G = .067\), 90\% CI \([.000, .169]\). Post-hoc \emph{t}-tests revealed that shapes associated with Good Person (548 \(\pm\) 9.4) were responded faster than Neutral-Person (582 \(\pm\) 10.9), (\emph{t}(33) = -3.95, \emph{p} = 0.0011) and Bad Person (582 \(\pm\) 10.2), \emph{t}(33) = -3.9, \emph{p} = 0.0013). While there was no significant differences between Neutral and Bad-Person condition (\emph{t}(33) = -0.01, \emph{p} = 0.999). For non-matched trials, there was no significant effect of Valence (\(F(1.99, 65.83) = 0.17\), \(p = .843\), \(\hat{\eta}^2_G = .001\), 90\% CI \([.000, .000]\)).
...
There was evidence for the main effect of valence, \(F(1.89, 64.37) = 11.09\), \(p < .001\), \(\hat{\eta}^2_G = .039\), 90\% CI \([.000, .123]\), and main effect of self-relevance, \(F(1, 34) = 3.22\), \(p = .082\), \(\hat{\eta}^2_G = .015\), 90\% CI \([.000, .139]\), as well as the interaction, \(F(1.79, 60.79) = 3.39\), \(p = .045\), \(\hat{\eta}^2_G = .022\), 90\% CI \([.000, .089]\).

We then conducted separated ANOVA for self-referential and other-referential trials. The valence effect was shown for the self-referential conditions, \(F(1.65, 56.25) = 13.98\), \(p < .001\), \(\hat{\eta}^2_G = .119\), 90\% CI \([.015, .236]\). Post-hoc test revealed that the Good-Self condition (1.97 \(\pm\) 0.14) was with greater \emph{d} prime than Netural condition (1.41 \(\pm\) 0.12, \emph{t}(34) = 4.505, \emph{p} = 0.0002), and Bad-self condition (1.43 \(\pm\) 0.102), \emph{t}(34) = 3.856, \emph{p} = 0.0014. There was difference between neutral and bad conidition, \emph{t}(34) = -0.238, \emph{p} = 0.9694. However, no effect of valence was found for the other-referential condition \(F(1.98, 67.36) = 0.38\), \(p = .681\), \(\hat{\eta}^2_G = .004\), 90\% CI \([.000, .009]\).

\hypertarget{reaction-time-4}{%
\subsubsection{Reaction time}\label{reaction-time-4}}

We found intercation between Matchness and Valence (\(F(1.98, 67.44) = 26.29\), \(p < .001\), \(\hat{\eta}^2_G = .025\), 90\% CI \([.000, .097]\)) and then analyzed the matched trials and mismatched trials separately, as in previous experiments.

For the matched trials, we found that the interaction between identity and valence, \(F(1.72, 58.61) = 3.89\), \(p = .032\), \(\hat{\eta}^2_G = .019\), 90\% CI \([.000, .084]\), as well as the main effect of valence \(F(1.98, 67.34) = 35.76\), \(p < .001\), \(\hat{\eta}^2_G = .079\), 90\% CI \([.000, .185]\), but not the effect of identity \(F(1, 34) = 0.20\), \(p = .660\), \(\hat{\eta}^2_G = .001\), 90\% CI \([.000, .052]\). As for the \emph{d} prime, we separated analyzed the self-referential and other-referential trials. For the Self-referential trials, we found the main effect of valence, \(F(1.80, 61.09) = 30.39\), \(p < .001\), \(\hat{\eta}^2_G = .159\), 90\% CI \([.038, .282]\); for the other-referential trials, the effect of valence is weaker, \(F(1.86, 63.08) = 2.85\), \(p = .069\), \(\hat{\eta}^2_G = .024\), 90\% CI \([.000, .095]\). We then focused on the self conditions: the good-self condition (713 \(\pm\) 12) is faster than neutral- (776 \(\pm\) 11.8), \emph{t}(34) = -7.396, \emph{p} \textless{} .0001 , and bad-self (772 \(\pm\) 10.1) conditions, \emph{t}(34) = -5.66, \emph{p} \textless{} .0001. But there is not difference between neutral- and bad-self conditions, \emph{t}(34) = 0.481, \emph{p} = 0.881.

For the mismatched trials, we didn't found any strong effect: identity, \(F(1, 34) = 3.43\), \(p = .073\), \(\hat{\eta}^2_G = .004\), 90\% CI \([.000, .098]\), valence \(F(1.89, 64.33) = 0.40\), \(p = .661\), \(\hat{\eta}^2_G = .001\), 90\% CI \([.000, .000]\), or interaction between the two \(F(1.94, 66.02) = 2.42\), \(p = .099\), \(\hat{\eta}^2_G = .007\), 90\% CI \([.000, .046]\).
...
There was evidence for the main effect of valence, \(F(1.92, 105.43) = 1.90\), \(p = .157\), \(\hat{\eta}^2_G = .005\), 90\% CI \([.000, .031]\), and main effect of self-relevance, \(F(1, 55) = 4.65\), \(p = .035\), \(\hat{\eta}^2_G = .017\), 90\% CI \([.000, .110]\), as well as the interaction, \(F(1.90, 104.36) = 5.58\), \(p = .006\), \(\hat{\eta}^2_G = .011\), 90\% CI \([.000, .051]\). Therefore we conducted repeated measure ANOVA for self and other conditions separately. We found the valence effect for self-referential condition (\(F(1.75, 96.42) = 6.73\), \(p = .003\), \(\hat{\eta}^2_G = .037\), 90\% CI \([.000, .102]\)) and other-referential condition (\(F(1.93, 105.97) = 0.61\), \(p = .539\), \(\hat{\eta}^2_G = .002\), 90\% CI \([.000, .017]\)). Post-hoc comparison for the self-referential conditions revealed that \emph{d}' was larger for good self (2.23 \(\pm\) 0.1087) than for bad self (1.66 \(\pm\) 0.098), \emph{t}(55) = 6.11, \emph{p} \textless{} 0.0001, Cohen's \emph{d} = 0.817, 95\% CI {[}0.511 1.117{]} , BF10 = 8.43, and neutral self (1.91 \(\pm\) 0.088), \emph{t}(55) = 3.03, \emph{p} = 0.0104, Cohen's \emph{d} = 0.404, 95\%CI {[}0.13 0.675{]} , BF10 = 1.33e+5. There was also higher d' for neutral-self condition than bad-self conditions, \emph{t}(55) = 3.02, \emph{p} = 0.0106, Cohen's \emph{d} = 0.403, 95\% CI {[}0.129 0.674{]}, BF10 = 8.22. For other-referential conditions, good-other (2.03 \(\pm\) 0.12) was smaller than neutral-other (2.28 \(\pm\) 0.133), \emph{t}(55) = -2.262, \emph{p} = 0.0699, but not the bad-other condition (2.19 \(\pm\) 0.122), \emph{t}(55) = -1.559, \emph{p} = 0.272. Neither evidence for the neutral and bad-other condition \emph{t}(55) = 1.11, \emph{p} = 0.51.
...
For the mismacthed trials, we also found interaction between of valence and identity, \(F(1.93, 106.25) = 35.51\), \(p < .001\), \(\hat{\eta}^2_G = .019\), 90\% CI \([.000, .069]\). Further analysis showed that there was effect of valence for other-referential trials (\(F(1.95, 107.38) = 36.43\), \(p < .001\), \(\hat{\eta}^2_G = .051\), 90\% CI \([.000, .123]\)) but not for the self-referential trials (\(F(1.98, 108.81) = 0.27\), \(p = .760\), \(\hat{\eta}^2_G = .000\), 90\% CI \([.000, .000]\)). Post-hoc comparison revealed that bad-other trials (857 \(\pm\) 20.9) were responded faster than good (967 \(\pm\) 25.1), \emph{t} = -9.625, \emph{p} \textless{} 0.0001, and neutral (876 \(\pm\) 21.4) trials, \emph{t} = -2.263, \emph{p} = 0.697, good-other conditions were also slower than neutral-other, \emph{t} = -8.016, \emph{p} \textless{} 0.0001
...
We conducted 2 (Identity: self v. other) by 3 (morality: good, neutral, bad) repeated measures ANOVA. The effect of identity (\(F(1, 58) = 121.04\), \(p < .001\), \(\hat{\eta}^2_G = .189\), 90\% CI \([.060, .334]\)), also the interaction between identity and valence, (\(F(1.99, 115.20) = 4.12\), \(p = .019\), \(\hat{\eta}^2_G = .004\), 90\% CI \([.000, .029]\)). But not the effect of valence was not found, \(F(1.93, 111.66) = 0.53\), \(p = .581\), \(\hat{\eta}^2_G = .000\), 90\% CI \([.000, .000]\). We further examined the effect of valence for both self and other. For the self-referential trials, there was a weak effect of valence \(F(1.95, 112.92) = 3.01\), \(p = .055\), \(\hat{\eta}^2_G = .008\), 90\% CI \([.000, .041]\). Post-hoc analysis showed that good self condition (2.55 \(\pm\) 0.111) is slightly higher than bad self condition (2.38 \(\pm\) 0.105) , \emph{t}(58) = 2.339, \emph{p} = .0583. But there was no differences between good-self and neutral self (2.45 \(\pm\) 0.101), \emph{t}(58) = 1.575, \emph{p} = .264, neither between neutral-self and bad-self, \emph{t}(58) = 0.966, \emph{p} = .601. As for the other-referential conditions, the result didn't show effect of valence \(F(1.98, 114.61) = 1.75\), \(p = .179\), \(\hat{\eta}^2_G = .003\), 90\% CI \([.000, .019]\).

\hypertarget{reaction-times-2}{%
\subsubsection{Reaction times}\label{reaction-times-2}}

We conducted 2 (Matchness: match v. mismatch) by 2 (Identity: self v. other) by 3 (morality: good, neutral, bad) repeated measure ANOVA. There was a main effect of Matchness (\(F(1, 58) = 79.85\), \(p < .001\), \(\hat{\eta}^2_G = .123\), 90\% CI \([.022, .262]\)) and interaction between Matchness and Identity(\(F(1, 58) = 81.15\), \(p < .001\), \(\hat{\eta}^2_G = .087\), 90\% CI \([.007, .218]\))

We carried out two separate ANOVA for both matched and mismatched trials. The results showed that for matched trials, there was an interaction between valence and identity, \(F(1.90, 110.18) = 4.41\), \(p = .016\), \(\hat{\eta}^2_G = .003\), 90\% CI \([.000, .006]\). However, there is no main effect of valence (\(F(1.98, 114.82) = 0.94\), \(p = .392\), \(\hat{\eta}^2_G = .001\), 90\% CI \([.000, .000]\)). We further broke down the interaction by analyzing the data for self and other pairs separately. There was a significant effect of moral valence for self-stimuli, \(F(1.97, 114.32) = 6.29\), \(p = .003\), \(\hat{\eta}^2_G = .006\), 90\% CI \([.000, .035]\), BF10 = 11.16. Paired \emph{t}-tests showed that good-self condition (654 ± 67) were faster relative to bad-self condition (665 ± 64.6), \emph{t}(58) = -3.47, \emph{p} = 0.0028, Cohen's \emph{d} = -0.451 CI {[}-0.718 -0.182{]}, \(BF_{10}\) = 27.0, and over neutral-self condition (664 ± 64), \emph{t}(58) = -2.78, \emph{p} = 0.013, Cohen's \emph{d} = -0.362, 95\% CI {[}-0.624 -0.097{]}, \(BF_{10}\) = 4.63. The neutral-self and bad-self conditions did not differ, \emph{t}(58) = -0.44, \emph{p} = 0.89, Cohen's \emph{d} = 0.0499, CI {[}-0.305 0.206{]}, \(BF_{10}\) = 0.153. For the stranger condition, the results showed that there was no difference among these conditions, \(F(1.95, 112.89) = 0.35\), \(p = .699\), \(\hat{\eta}^2_G = .001\), 90\% CI \([.000, .000]\), \(BF_{10}\) = 0.077.

For non-matched trials, there was no significant effect. Morality (\(F(1, 58) = 0.16\), \(p = .692\), \(\hat{\eta}^2_G = .000\), 90\% CI \([.000, .000]\)), Identity(\(F(1.96, 113.52) = 0.68\), \(p = .508\), \(\hat{\eta}^2_G = .000\), 90\% CI \([.000, .000]\)), interaction (\(F(1.90, 110.27) = 0.04\), \(p = .953\), \(\hat{\eta}^2_G = .000\), 90\% CI \([.000, .000]\)).
...
We conducted 2 (Identity: self v. other) by 3 (morality: good, neutral, bad) repeated measure ANOVA. The results revealed no effect of valence (\(F(1.59, 69.94) = 2.34\), \(p = .115\), \(\hat{\eta}^2_G = .010\), 90\% CI \([.000, .054]\)), or identity, \(F(1, 44) = 0.00\), \(p = .994\), \(\hat{\eta}^2_G = .000\), 90\% CI \([.000, .000]\), or their interactions, \(F(1.96, 86.41) = 0.53\), \(p = .585\), \(\hat{\eta}^2_G = .001\), 90\% CI \([.000, .000]\).
...
For non-matched trials, there was no significant effect. Identity (\(F(1, 44) = 1.96\), \(p = .169\), \(\hat{\eta}^2_G = .001\), 90\% CI \([.000, .043]\)), interaction (\(F(1.88, 82.57) = 0.31\), \(p = .718\), \(\hat{\eta}^2_G = .000\), 90\% CI \([.000, .000]\)). But here are effect of Valence (\(F(1.69, 74.54) = 6.59\), \(p = .004\), \(\hat{\eta}^2_G = .010\), 90\% CI \([.000, .053]\))
...
We conducted 4 (task type: morality, emotion, person, scene) by 3 (morality: good, neutral, bad) repeated measure ANOVA. The results revealed no effect of task type (\(F(2.95, 108.97) = 1.18\), \(p = .321\), \(\hat{\eta}^2_G = .006\), 90\% CI \([.000, .017]\)), but revealed effect of valence, \(F(1.85, 68.49) = 29.70\), \(p < .001\), \(\hat{\eta}^2_G = .034\), 90\% CI \([.000, .112]\), and their interactions, \(F(4.68, 173.09) = 5.85\), \(p < .001\), \(\hat{\eta}^2_G = .019\), 90\% CI \([.000, .029]\).

We then conducted ANOVA separately for four different tasks. For the morality task, the valence effect \(F(1.96, 72.66) = 2.22\), \(p = .116\), \(\hat{\eta}^2_G = .008\), 90\% CI \([.000, .047]\).

For emotion conditions, we found that main effect of valence \(F(1.69, 62.65) = 5.28\), \(p = .011\), \(\hat{\eta}^2_G = .030\), 90\% CI \([.000, .103]\). Post-hoc comparison showed that good (2.13, SE = 0.161) was not different from neutral condition (2.10, SE = 0.125), \emph{t}(37) = 0.163, \emph{p} = 0.9854, but both are higher than than bad condition (1.79, SE = 0.148) (neutral \textgreater{} bad, \emph{t}(37) = 3.588, \emph{p} = 0.0027; good \textgreater{} bad, \emph{t}(37) = 2.62, \emph{p} = 0.0332).

For the person appearance, the main effect of valence is significant, \(F(1.73, 64.02) = 27.22\), \(p < .001\), \(\hat{\eta}^2_G = .088\), 90\% CI \([.004, .192]\). Post-hoc analysis found that good condition (2.4, SE = 0.167) was higher than both neutral (1.71, SE = 0.175, \emph{t}(37) = 5.482, \emph{p} \textless{} .0001) and bad (1.70, SE = 0.182, \emph{t}(37) = 6.365, \emph{p} \textless{} .0001), but neutral and bad condition are not different (\emph{t}(37) = 0.197, \emph{p} =0.9788).

For scene appearance, the main effect of valence was significant \(F(1.79, 66.40) = 14.02\), \(p < .001\), \(\hat{\eta}^2_G = .072\), 90\% CI \([.000, .171]\). Post-hoc analysis revealed the same pattern as in person task: good condition (2.23, SE = 0.156) is higher than both neutral (1.57, SE = 0.178, \emph{t}(37) =4.683, \emph{p} = 0.0001) and bad (1.77, SE = 0.148, \emph{t}(37) = 3.414, \emph{p} = 0.0044), but neutral and bad conditions are not different (\emph{t}(37) = -1.893, \emph{p} = 0.1549)
...
We din't found the main effect of task type (\(F(2.06, 76.12) = 0.56\), \(p = .577\), \(\hat{\eta}^2_G = .004\), 90\% CI \([.000, .003]\)), but the main effect of valence (\(F(1.82, 67.23) = 53.98\), \(p < .001\), \(\hat{\eta}^2_G = .076\), 90\% CI \([.000, .176]\)), and intercation between Matchness and Valence (\(F(3.58, 132.31) = 3.12\), \(p = .021\), \(\hat{\eta}^2_G = .013\), 90\% CI \([.000, .017]\)). We then analyze the effect of valence for each task type. We found that for all four task, the valence effect was significant: morality (\(F(1.89, 69.98) = 8.66\), \(p = .001\), \(\hat{\eta}^2_G = .036\), 90\% CI \([.000, .115]\)), emotion (\(F(1.48, 54.68) = 9.74\), \(p = .001\), \(\hat{\eta}^2_G = .072\), 90\% CI \([.000, .170]\)), person (\(F(1.78, 65.78) = 39.39\), \(p < .001\), \(\hat{\eta}^2_G = .162\), 90\% CI \([.044, .281]\)), scene (\(F(1.75, 64.69) = 17.71\), \(p < .001\), \(\hat{\eta}^2_G = .102\), 90\% CI \([.010, .211]\)). Post-hoc analyses revealed that for emotion task, the good condition is reacted faster than bad condition (\emph{t}(37) = 3.475, \emph{p} = 0.0037) but not neutral conditions are not different ((\emph{t}(37) = -0.77, \emph{p} = 0.7236)). The bad condiiton is longer than the neutral (\emph{t}(37) = 5.09, \emph{p} \textless{} 0.0001). The pattern is different for morality, person, and scence tasks, which showed that good is faster than both neutral ((\emph{ts}(37) = {[}-7.289 -2.4{]}, \emph{ps} \textless{} 0.0548)) and bad (\emph{ts}(37) = {[}-7.232 -3.817{]}, \emph{ps} \textless{} 0.0014).
...
We found intercation between Matchness and Valence (\(F(1.97, 45.20) = 20.45\), \(p < .001\), \(\hat{\eta}^2_G = .021\), 90\% CI \([.000, .102]\)) and then analyzed the matched trials and mismatched trials separately, as in experiment 2. For matched trials, we found the effect of valence \(F(1.97, 45.25) = 32.37\), \(p < .001\), \(\hat{\eta}^2_G = .078\), 90\% CI \([.000, .206]\). For non-matched trials, there was no significant effect of Valence (\(F(1.77, 40.67) = 0.35\), \(p = .679\), \(\hat{\eta}^2_G = .000\), 90\% CI \([.000, .000]\)). Post-hoc \emph{t}-tests revealed that shapes associated with Good Person (mean = 550, SE = 13.8) were responded faster than Neutral-Person (501, SE = 14.7), (\emph{t}(24) = -5.171, \emph{p} = 0.0001) and Bad Person (523, SE = 16.3), \emph{t}(24) = -8.137, \emph{p} \textless{} 0.0001)., and Neutral is faster than Bad-Person condition (\emph{t}(32) = -3.282, \emph{p} = 0.0085).
...
There was evidence for the interaction between identity and valence, \(F(1.28, 26.90) = 12.88\), \(p = .001\), \(\hat{\eta}^2_G = .041\), 90\% CI \([.000, .150]\). We further split the self- and other-relevant trials. For the self trials, there was significant effect of valence, \(F(1.73, 36.42) = 29.31\), \(p < .001\), \(\hat{\eta}^2_G = .147\), 90\% CI \([.006, .301]\). Post-hoc comparison showed that the good-self condition (2.71, SE = 0.199) is better than both neutral-self (1.98, SE = 0.151), \emph{t}(21) = 5.984, \emph{p} \textless{} 0.001, and bad-self condition (2.07, SE = 0.154), \emph{t}(21) = 6.555, \emph{p} \textless{} 0.001. But there was no significant difference between bad-self and neutral-self, \emph{t}(21) = -1.059, \emph{p} = 0.549. For other trials, there was no significant effect of valence, \(F(1.75, 36.72) = 0.00\), \(p = .999\), \(\hat{\eta}^2_G = .000\), 90\% CI \([.000, .000]\).

\hypertarget{rt}{%
\paragraph{RT}\label{rt}}

For the matched trials, there was interaction between identity and valence, \(F(1.72, 36.16) = 4.55\), \(p = .022\), \(\hat{\eta}^2_G = .015\), 90\% CI \([.000, .033]\). We split the self-relevant and other relevant trials separately. For the self condition, the valence effect is significant, \(F(1.92, 40.38) = 14.48\), \(p < .001\), \(\hat{\eta}^2_G = .112\), 90\% CI \([.000, .257]\). The Self-good (484, SE = 13.2) is faster than self-neutral (543, SE = 16.7) , \emph{t} = -4.521, \emph{p} = 0.0005, \emph{df} = 21 and self-bad condition (535, SE = 18.4), \emph{t} = -4.489, \emph{p} = 0.0006, \emph{df} = 21. but not significant different between neutral and bad condition, \emph{t} = 0.689, \emph{p} = 0.772, \emph{df} = 21. For other condition, there was no effect of valence, \(F(1.79, 37.50) = 1.04\), \(p = .356\), \(\hat{\eta}^2_G = .008\), 90\% CI \([.000, .053]\).
...
There was evidence for the interaction between identity and valence, \(F(1.65, 34.62) = 3.86\), \(p = .038\), \(\hat{\eta}^2_G = .005\), 90\% CI \([.000, .037]\). We further split the self- and other-relevant trials. For the self trials, there was significant effect of valence, \(F(1.79, 37.62) = 7.35\), \(p = .003\), \(\hat{\eta}^2_G = .021\), 90\% CI \([.000, .106]\). Post-hoc comparison showed that the good-self condition (2.71, SE = 0.214) is better than both neutral-self (2.43, SE = 0.175), \emph{t}(21) = 2.98, \emph{p} = 0.0189, and bad-self condition (2.43, SE = 0.199), \emph{t}(21) = 3.93, \emph{p} = 0.0021. But there was no significant difference between bad-self and neutral-self, \emph{t}(21) = -0.097, \emph{p} = 0.995. For other trials, there was no significant effect of valence, \(F(1.73, 36.28) = 1.46\), \(p = .246\), \(\hat{\eta}^2_G = .004\), 90\% CI \([.000, .026]\).

\hypertarget{rt-1}{%
\paragraph{RT}\label{rt-1}}

For the matched trials, the interaction between identity and valence, \(F(1.62, 34.10) = 3.04\), \(p = .071\), \(\hat{\eta}^2_G = .005\), 90\% CI \([.000, .036]\). As in previous studies, we split the self- and other-relevant trials. For the self condition, the valence effect is significant, \(F(1.46, 30.76) = 6.57\), \(p = .008\), \(\hat{\eta}^2_G = .023\), 90\% CI \([.000, .110]\). The Self-good (480, SE = 16.9) is faster than self-neutral (504, SE = 17.3) , \emph{t} = -2.289, \emph{p} = 0.0795, \emph{df} = 21 and self-bad condition (508, SE = 17.9), \emph{t} = -4.342, \emph{p} = 0.0008, \emph{df} = 21. but not significant different between neutral and bad condition, \emph{t} = -0.503, \emph{p} = 0.871, \emph{df} = 21. For other condition, there was no effect of valence, \(F(1.91, 40.04) = 1.75\), \(p = .188\), \(\hat{\eta}^2_G = .007\), 90\% CI \([.000, .051]\).
...
\begin{figure}
\centering
\includegraphics{Suppl_Materials_individual_Exp_files/figure-latex/plot-person-dist-1.pdf}
\caption{\label{fig:plot-person-dist}Self-rated personal distance}
\end{figure}

\begin{figure}
\centering
\includegraphics{Suppl_Materials_individual_Exp_files/figure-latex/plot-person-dist-net-1.pdf}
...
\leavevmode\vadjust pre{\hypertarget{ref-DeCarlo_1998}{}}%
DeCarlo, L. T. (1998). Signal detection theory and generalized linear models {[}Journal Article{]}. \emph{Psychological Methods}, \emph{3}(2), 186--205. \url{https://doi.org/10.1037/1082-989X.3.2.186}
...
\leavevmode\vadjust pre{\hypertarget{ref-matzke_psychological_2009}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Stanislaw_Todorov_1999}{}}%
Stanislaw, H., \& Todorov, N. (1999). Calculation of signal detection theory measures {[}Journal Article{]}. \emph{Behavior Research Methods, Instruments, \& Computers}, \emph{31}(1), 137--149. \url{https://doi.org/10.3758/BF03207704}
...
\leavevmode\vadjust pre{\hypertarget{ref-wiecki_hddm_2013}{}}%
