...
e5.rt.t.m.mrl_imm_oth <- t.test(df5.V.RT.subj_w$match_other_moral,df5.V.RT.subj_w$match_other_immoral,paired = TRUE)
df5.V.RT.subj_w$m.mrl_imm_oth <- df5.V.RT.subj_w$match_other_moral - df5.V.RT.subj_w$match_other_immoral
...
e5.rt.t.m.mrl_ave_oth <- t.test(df5.V.RT.subj_w$match_other_moral,df5.V.RT.subj_w$match_other_average,paired = TRUE)
df5.V.RT.subj_w$m.mrl_ave_oth <- df5.V.RT.subj_w$match_other_moral - df5.V.RT.subj_w$match_other_average
...
e5.rt.t.m.imm_ave_oth <- t.test(df5.V.RT.subj_w$match_other_immoral,df5.V.RT.subj_w$match_other_average,paired = TRUE)
df5.V.RT.subj_w$m.imm_ave_oth <- df5.V.RT.subj_w$match_other_immoral - df5.V.RT.subj_w$match_other_average
...
tiff(filename = "Figure exp5. d prime and RTs of Experiment 5 (way 1).tiff", width = 8, height = 6, units = 'in', res = 300)
multiplot(e5.p_dprime1,e5.p_rt1,cols = 2)
dev.off()

tiff(filename = "Figure exp5. d prime and RTs of Experiment 5 (way 2).tiff", width = 8, height = 6, units = 'in', res = 300)
