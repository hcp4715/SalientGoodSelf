...
#### Data analysis
As described in general methods section, we used three approaches to analyze the behavioral data: Classical NHST, Bayesian Hierarchical Generalized Linear Model, and Hierarchical drift diffusion model. 
 <!-- Shall I write more about HDDM here, or just refer the interested reader to the paper? -->

### Results

We only reported the Bayesian hierarchical GLM results for hypothesis testing, all the classic NHST results can be found in the online supplementary results. Also, we only presented the plots for match trials, all plots for nonmatch trials were in the online supplementary results.
...
p_1a_hddm <- params_p %>% 
  ...
  dplyr::filter(matchness == 'Nonmatch') %>%
