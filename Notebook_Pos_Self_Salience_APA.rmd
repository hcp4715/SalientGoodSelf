...
df4b_dprime_anova <- afex::aov_ez('Subject','dprime',df4b_dprime_long, 
                                  within = c('Identity','Morality'))  # using afex's function
apa_anova <- apa_print(df4b_dprime_anova)
...
#pairs(m3)
```
Morality (`r apa_anova$full$Morality`) and Identity gender affected post-surgery quality of life, `r apa_anova$full$Identity`. However, the effect of gender differed by clinic, `r apa_anova$full$Identity_Morality`.
