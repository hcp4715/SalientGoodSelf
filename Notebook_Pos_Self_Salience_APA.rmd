...
To avoid the cases that some participants participated more than one experiments, we inspected the all available information about participants. For those participants who did take part in more than one experiments, only the results from their first participation were included. As mentioned above, 24 participants were intentionally recruited to participate both exp 1a and exp 2, we only included their results from exp 1a in the current meta-analysis.
