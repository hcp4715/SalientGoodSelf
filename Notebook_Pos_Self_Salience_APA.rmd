...
Previous studies have showed that the process of visual stimuli is prioritized because for various reasons: salient physical features, affective value or rewarding value [attention capture related papers]. However, to navigate in the social world, we also need to decide how to allocate our limited cognitive resources to the rich social information. Self-relevant, for sure. Recent studies showed that moral related information also prioritized (@brady_attentional_2020). Among all moral related information, character related information is also prioritized (@eiserbeck_visual_2020, @gantman_moral_2014). Studies used instantly acquired character related information to neutral faces and then tested these faces with various cognitive task, most studies found that neutral faces associated with negative social behavioral were prioritized as compared to neutral (and positive) [@anderson_visual_2011, @eiserbeck_visual_2020, but see @stein_no_2017]. 

Why the character related information are prioritized? One possibility is that the character of others helps us to distinguish the potential cooperators and free-riders. That is, we will avoid potential free-riders and approach to potential cooperators. This value-based explanation had been used to account for many results [], yet few studies directly tested the value-based account. In moral psychology, however, there was a different view on why we judge other as good or bad: we doing so because we want to know who is us and who is other []. In other words, character is a signal of social categorization, indicating whether we can treat someone as extension of the self. 

Social associative learning task: "Even minimal behavioral information, such as a single sentence, is sufficient for robust positive or negative associations with a person’s face (Bliss-Moreau, Barrett, & Wright, 2008; Falvello, Vinson, Ferrari, & Todorov, 2015; Todorov & Olson, 2008). This demonstrates the readiness and ease with which such affective learning occurs – even in cases where the veracity of the information is unclear (Baum, Rabovsky, Rose, & Abdel Rahman, 2018)."
