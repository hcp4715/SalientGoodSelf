...
# The rate of the correct response with less than 200 ms reaction time
...
df1a_dprime_anova <- afex::aov_ez('Subject','dprime',df1a_dprime_long,  # using afex's function 
                                  within = c('Valence'))
...
# anova for d prime with 2*2 design
df1a_RT_anova <- afex::aov_ez('Subject','RT',df1a_rt_acc_long,     # using afex's function 
