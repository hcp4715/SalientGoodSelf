...
```{r plot correlation,echo=FALSE, results='hide', warning=FALSE, message=FALSE}
# Permutation
set.seed(12345)
...
```{r plot-corr-2, fig.cap="Correlation between moral self-image, self esteem, and behavior", fig.width=8, warning=FALSE}
library(patchwork)
...
```{r plot-corr-3, fig.cap="Correlation between moral identity and behavior", fig.width=8, warning=FALSE}
library(patchwork)
