---
title             : "Self-referential processes prioritize moral character in perceptual matching"
...
abstract: |
 Evidence for the prioritization of moral information in cognitive processes is mixed. Here we examined this question using a series of well-controlled matching experiments where participants acquired associations between moral character and geometric shapes and then performed a simple perceptual matching task. Across five experiments, we found a robust prioritization of good characters. We then tested two competing explanations for this effect: the valence account, which predicts positive bias in general, and the self-binding account, which predicts a self-specific positive bias. We found evidence for the self-binding account across three experiments: good characters associated with the self were prioritized but not when associated with others across three experiments. Two additional experiments revealed that merely presenting self and good character information simultaneously facilitated the performance. Together, these results suggested a robust prioritization effect of good character and that the self-referential process is the key to such a prioritization effect.
