...
library(patchwork)
p1 <- (p_exp4a_rt1 + exp4a_sdt_p) + plot_layout(nrow = 1, byrow = FALSE, guides = "collect") 
...
library(patchwork)
p3 <- (p_exp4b_rt1 + exp4b_sdt_p ) + plot_layout(nrow = 1, byrow = FALSE, guides = "collect") 
...
```{r plot-exp4-all, fig.cap="exp4a: Results of Bayesian GLM analysis.",  fig.height=9, fig.width=12, warning=FALSE}
library(patchwork)
(((p_exp4a_rt1 + exp4a_sdt_p + plot_layout(guides = "collect", nrow = 1)) + 
        ...
        plot_layout(nrow =2, byrow = TRUE, guides = "keep") +  plot_annotation(tag_levels = 'A')  
