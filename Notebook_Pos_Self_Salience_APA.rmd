...
```{r 'ex5-dprime-rt', fig.cap="RT and *d* prime of Experiment 4b.", fig.height=6, fig.width=15, warning=FALSE}
# calculating the dprime 
...
Figure \@ref(fig:ex4b-dprime-rt) shows *d* prime and reaction times of experiment 5.
