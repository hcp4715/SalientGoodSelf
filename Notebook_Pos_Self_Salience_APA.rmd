...
abstract: |
 Moral character is central to social evaluation and moral judgment. However, whether moral character information is prioritized in perceptual decision-making was debated. Here we investigated the effect of moral character on perceptual decision-making through an associative learning task, where participants first learned associations between different geometric shapes and moral characters and then performed a simple perceptual matching task. With nine experiments (N = 404) we found that (1) there is a robust prioritization effect of good character-related information, i.e., participants responded faster and more accurately to geometric shapes that were associated with good characters than shapes that were associated with neutral or bad characters; (2) the prioritization of good character was not determined by the valence *per se* but modulated by a self-referential process, i.e., the prioritization effect of good character were robust only when the good character referred to the self but weak or non-exist when it referred to others; (3) the mutual facilitation effect between the moral character and self-referential information occurred even when one of them was task-irrelevant. Together, these results suggested a spontaneous moral-self referential process as a mechanism of the prioritization effect of good character.
...
Morality is central to our social life. We not only experience a substantial amount of moral events every day [e.g., @hofmann_morality_2014] but also judge people’s moral character as "good" or "bad" all the time [@uhlmann_person-centered_2015]. Actually, moral character is so important that it is a basic dimension in social evaluation [@goodwin_moral_2014; @goodwin_moral_2015]. The information about the moral character of others helps us to distinguish between “us” and “them” [@ellemers_morality_2018] and decide who to cooperate with []. Because of its importance, we devote a substantial part of our conversations to gossiping about others' moral character [e.g., @dunbar_gossip_2004]. 

The importance of moral character may also extend to perception []. A number of studies have explored the extent to which moral character prioritized in visual perception and suggested that moral information influence visual perception via top-down processes. However, the top-down account of moral character's effect on perception evoked a on-going debate in the literature [@firestone_bbs_2016;@jussim_interpretations_2016]. 

The current study set out to examine the effect of moral character on perceptual decision-making. First, we conducted a series of experiment to examine the existence of a prioritization effect of moral character. The results of these experiments, i.e., a prioritization effect of good character, led us to the second question: why positive moral character are prioritized instead of negative moral character in perceptual matching task? We hypothesized that good character are prioritized because of a spontaneous self-referential processes instead of value-based attention. We tested this hypothesis with three experiments and found that the prioritization effect of good character only exist when moral character are self-referential but diminished when moral character are other-referential. These results further motivated us to test the automaticity of self-referential processing to moral character information. And we found that good character and self-relevant information automatically binding with each other and facilitate the perceptual decision-making.

## Prioritization effect of moral character
@anderson_visual_2011 conducted a study in which participants were asked to associate faces with different behaviors (e.g., negative and neutral behaviors from social and nonsocial domains) and then performed a binocular rivalry task. The results of this study indicated that faces associated with negative social behaviors dominated participants' visual awareness for a longer time compared to faces associated with other types of behaviors  [but see @stein_no_2017]. @eiserbeck_visual_2020 also reported the influence of bad moral character on perception by combining associative learning with the attentional blink paradigm. This study found that neutral faces associated with negative behaviors were processed preferentially. The effect of good moral characters was also reported in studies. For example, when participants are asked to classify words as good or bad, positive trait words are classified faster than negative words [@bargh_generality_1992]. Similarly, in a lexical decision task, participants judge positive words faster than negative words [@unkelbach_good_2010]. Also, @anisfeld_when_1966 found that positive words are easier to associate with nonsense word-like strings, and this advantage in associative potential also appeared in implicit association test (IAT) [@anselmi_positive_2011]. Direct evidence for positivity effect of moral character also exist: @shore_social_2013 found that faces with positive interaction in a trust game were prioritized in pre-attentive process.However, 

## Value-based attention or self-referential process?

These studies, however, ignored the agency of participants who is perceiving the information and making perceptual decisions. The external stimuli only contain subjective value if they are relevant to the self of the decision-maker [@juechems_where_2019]. When it comes to moral character, there are long-history of studies showing that moral character is central for people's self-concept and identity. A positive moral character is viewed as the core feature of identity [e.g., @strohminger_true_2017]. Empirical evidence supported the notion that people distort their perception [], memory [], and change their actions [] to maintain a positive view of their moral self-view. Given this strong motivation, it is possible that participants has spontaneous self-referential process for the perception tasks where no self-referential process were not explicitly excluded [citation related to spontaneous self-referential].
...
# fit a three-level hierarchical model for RT, didn't specify the prior, lognormal, dummy coding
RT_ms_m1 <- df_ms %>%
  dplyr::mutate(RT_sec = RT/1000) %>% # log RT in seconds
  dplyr::filter(ACC == 1) %>%         # only correct trials
