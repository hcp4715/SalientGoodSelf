...
```
In most of these experiments, participant were also asked to fill a battery of questionnaire after they finish the cognitive tasks. All the questionnaire data are open [see, dataset 4 in @Liu_2019_JOPD]. See Table 1 for a summary information about all the experiments reported here. 
