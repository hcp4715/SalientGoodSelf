...
abstract: |
 Researchers in moral psychology had long assumed that information related to bad moral character is prioritized in cognitive processing, yet the evidence is scarce. A main challenage lies operationalizing moral character to suit cognitive tasks. Social associative learning task, where participants first learn the associations between social conceptions and neutral stimuli and then perform cognitive tasks (e.g., matching judgment), had been proved to be an effective way to study the information processing of social and affective factors. Here, we examined the information process of moral character using social associataive learning task. Across 9 experiments (N = 4XX, trials = XXX), we found a robust but opposite effect: shapes associated with good character were prioritized, as compared to shapes associated with neutral or bad characters. Crucially, good character effect was robust when it referred to the self but weak or non-exist when it referred to a stranger. Moreover, even when identity or moral character information became task-irrelevant, good character still interact with self-referential processing: the good-self combination facilitate the process while the good-other combination slowed down the process. Together, these results suggested a positiviity bias in social associative learning task where good character are prioritized.
...
[Unkelbach et al., 2020, Similarity theory of positivity and negativiity bias, a very comprehensive review of positivity effect and negativity effect in social cognition. Especially interesting is that, with extensive studies on the negative primacy of negative information (diagnositicity), positive effect is robust and consistent in associative potential and processing speed. as early as in 1966, researcher found that positive word pairs were better learned, and in 2011, researcher found that IAT effect was driven by positivity effect. Interestingly, in our task, we basically have two processes: associative learning, and classification (matching judgment), which means that our results should be not a surprise if we considering these factors.

[morality is central to social life, moral character is the central of morality]
People experience a substantial amount of moral events in everyday life [e.g., @hofmann_morality_2014]. Whether we are the agent, target, or a third party of a moral event, we always judge moral behaviors as "right" or "wrong", and by doing so, we judge moral character of people as "good" or "bad" [@uhlmann_person-centered_2015]. Moral character is so important in social life that it is a basic dimension for social evaluation [@goodwin_moral_2014; @goodwin_moral_2015; @abele_navigating_2020] and that a substantial part of people's conversation are gossiping others' moral character (or, reputation) [e.g., @dunbar_gossip_2004]. The importance of moral character may have been internalized to individuals' self-concept and the positive moral self is the most important aspect of identity [e.g., @strohminger_true_2017], and moral character is a standard we used to evaluate our in-group members and distinguish out-group members [@ellemers_morality_2018]. 

[No real perceptual studies on moral character]
Given the importance of moral character, people often assume that moral character related information are prioritized in human information processing system, especially 'bad' agents [e.g., @baumeister_bad_2001; @pratto_automatic_1991]. The negativity effect in impression formation [@anderson_averaging_1965; @fiske_attention_1980; @skowronski_social_1987], however, does not mean that the same effect exists in perceptual process [see a recent review, @unkelbach_chapter_2020]. Evidence suggests that bad is not necessarily stronger than good in all aspect of information processing. In some situations, good is stronger than bad. For example, when participants are asked to classify words as good or bad, positive words are classified faster than negative words. Similarly, in the lexical decision task, participants judge positive words faster than negative words. Also, @anisfeld_when_1966 found that positive words are easier to associate with nonsense words, and this advantage in associative potential also appeared in implicit association test (IAT) [@anselmi_positive_2011]. However, there are few data concerning how moral character information are processed at perceptual level, because, as @freeman_dynamic_2011 put it, most studies in person perception didn't try to explain the perceptual process itself, rather, they are trying to explain the higher-order social cognitive processes that come after. Therefore, it remains unclear (1) whether moral character related information are prioritized in information processing (e.g., perception) and, if yes, (2) what are the underlying mechanisms of the prioritization effect.
