...
In the third part, we will examine the change of effect size brought by change of design, with a focus on 4a, 4b, and 5, which were designed to address the generalizibility problems. 
...
### Does this effect exist when reference manipulated implicitly?

### Is this effect morality-specific?
