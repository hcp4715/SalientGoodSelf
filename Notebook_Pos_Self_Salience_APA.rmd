...
# Discussion
Across nine experiments, we investigated the processing of moral character using a combination of social associative learning and perceptual matching task. We explored the mechanisms underlying the effect and found robust evidence that good character prioritized the shape-label matching task, regardless of the stimuli that used for representing moral characters. Moreover, this prioritization of good character was driven by a spontaneous self-referential processing: prioritization only occur when moral characters are self-referential but not other-referential. The prioritization effect occur when both self and good character are presented, regardless of their task-relevance. In contrast, when good character became other-referential, even implicitly, the information process was slowed down, suggesting a process that opposite to self-binding. Together, these findings highlight the importance of the self-referential in perceiving information related to good character. These findings contributed to a growing literature on the social nature of perception [@xiao_perceiving_2016; @freeman_chapter_2020] by supporting the idea that people can prioritized not just physically salient, or affective stimuli, but also socially salient stimuli, i.e., instantly acquired moral information.
