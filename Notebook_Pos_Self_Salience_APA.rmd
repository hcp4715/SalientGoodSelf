...
df.corr <- merge(df.q_scores.v, df.meta_all_wide[c("Subject","Bad_v", "Good_v", "Neutral_v")], by.x = 'subjID', by.y = 'Subject')
...
corrplot::corrplot(res.cor, method="circle", type = 'upper', sig.level = .05)
