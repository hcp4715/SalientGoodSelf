...
### Prioritization of good character is modulated by self-referential
...
### Spontaenous binding between self and good character
...
We did not analyze the questionnaire data, which were described in [@Liu_2020_JOPD].