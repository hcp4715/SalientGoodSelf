...
apa_table(
  ...
  , note = "Stim of Morality = How moral character was manipulated; Presenting order = how shapes & labels were presented. The data from experiments 7a & 7b, which were reported in Hu et al (2020), are not analyzed here."
  , escape = TRUE
)
```
