...
#### NHST
```{r 'exp4b-dprime-rt', fig.cap="RT and *d* prime of Experiment 3a.", fig.height=6, fig.width=10, warning=FALSE}
...
df4b_dprime_s_anova_apa <- df4b_dprime_s_anova %>% papaja::apa_print.afex_aov()
...
df4b_dprime_o_anova <- df4b.v.dprime_l %>%
  ...
  afex::aov_ez('Subject','dprime', ., within = c('Valence'))
df4b_dprime_o_anova_apa <- df4b_dprime_o_anova %>% papaja::apa_print.afex_aov()
...
# d-prime
hypothesis(exp4b_sdt_m1, "IdentitySelf:ValenceGood:ismatch > IdentitySelf:ValenceNeutral:ismatch")  # .82
hypothesis(exp4b_sdt_m1, "IdentitySelf:ValenceGood:ismatch > IdentitySelf:ValenceBad:ismatch")  # .75
hypothesis(exp4b_sdt_m1, "IdentitySelf:ValenceNeutral:ismatch > IdentitySelf:ValenceBad:ismatch")  # .44
hypothesis(exp4b_sdt_m1, "IdentityOther:ValenceGood:ismatch > IdentityOther:ValenceNeutral:ismatch")  # .11
hypothesis(exp4b_sdt_m1, "IdentityOther:ValenceGood:ismatch > IdentityOther:ValenceBad:ismatch")  # .07
hypothesis(exp4b_sdt_m1, "IdentityOther:ValenceNeutral:ismatch > IdentityOther:ValenceBad:ismatch")  # .39

hypothesis(exp4b_sdt_m1, "IdentitySelf:ValenceGood:ismatch > IdentityOther:ValenceGood:ismatch")  # 1
hypothesis(exp4b_sdt_m1, "IdentitySelf:ValenceNeutral:ismatch > IdentityOther:ValenceNeutral:ismatch")  # 1
hypothesis(exp4b_sdt_m1, "IdentitySelf:ValenceBad:ismatch > IdentityOther:ValenceBad:ismatch")  # 1
...
# hypothesis(exp4b_sdt_m1, "IdentitySelf:ValenceBad > IdentityOther:ValenceBad")  # .96
