...
e5.d.t.mrl_imm_slf <- t.test(df5.V.SDT_ww$Self_Good,df5.V.SDT_ww$self_immoral,paired = TRUE)
df5.V.SDT_ww$mrl_imm_slf <- df5.V.SDT_ww$Self_Good - df5.V.SDT_ww$self_immoral
...
e5.d.t.mrl_ave_slf <- t.test(df5.V.SDT_ww$Self_Good,df5.V.SDT_ww$self_average,paired = TRUE)
df5.V.SDT_ww$mrl_ave_slf <- df5.V.SDT_ww$Self_Good - df5.V.SDT_ww$self_average
...
e5.d.t.slf_oth_mrl <- t.test(df5.V.SDT_ww$Self_Good,df5.V.SDT_ww$other_moral,paired = TRUE)
df5.V.SDT_ww$slf_oth_mrl <- df5.V.SDT_ww$Self_Good - df5.V.SDT_ww$other_moral
