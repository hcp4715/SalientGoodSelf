...
hypothesis(exp1a_sdt_m1, "ValenceNeutral:ismatch > ValenceBad:ismatch")   # 0.92
hypothesis(exp1a_sdt_m1, "ValenceGood > ValenceNeutral")  # 0.81
hypothesis(exp1a_sdt_m1, "ValenceGood > ValenceBad")      # .94
hypothesis(exp1a_sdt_m1, "ValenceNeutral > ValenceBad")   # 0.79
...
hypothesis(exp1c_sdt_m1, "ValenceGood:ismatch > ValenceNeutral:ismatch")  # 0.73
hypothesis(exp1c_sdt_m1, "ValenceGood:ismatch > ValenceBad:ismatch")      # .79
hypothesis(exp1c_sdt_m1, "ValenceNeutral:ismatch < ValenceBad:ismatch")   # 0.99
hypothesis(exp1c_sdt_m1, "ValenceGood > ValenceNeutral")  # 0.4
hypothesis(exp1c_sdt_m1, "ValenceGood > ValenceBad")      # 0.73
hypothesis(exp1c_sdt_m1, "ValenceNeutral > ValenceBad")   # 0.79
...
hypothesis(exp1c_rt_m1, "ValenceGood:ismatch < 0")  # Match good < Match Neutral, p = 0.99
hypothesis(exp1c_rt_m1, "ValenceBad:ismatch > 0")   # Match Bad > Match Neutral, p = 0.74
hypothesis(exp1c_rt_m1, "(ValenceGood:ismatch - ValenceBad:ismatch) < 0")   # Match Good < Match Bad, p = 1
